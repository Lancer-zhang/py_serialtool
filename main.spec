...
a = Analysis(['main.py'],
             ...
             binaries=[],
             datas=[],
             hiddenimports=['configparser', 'mainwindowhandler', 'src.mainwindowhandler', 'src/mainwindowhandler', 'serial', 'serial.tools.list_ports', 'tkinter.messagebox', 'numpy', 'codecs'],
             hookspath=[],
             runtime_hooks=[],
             excludes=[],
